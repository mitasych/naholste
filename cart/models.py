...
class OrderOption(models.Model):
	...
	char_id = models.CharField(u'Изображение', max_length=32, blank=True, default='', editable=False)
	...
	frame = models.ForeignKey(Frames, blank=True, editable=False)
	packaging = models.ForeignKey(Packaging, blank=True, editable=False)
